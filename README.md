...
Ansible playbook for deploy an ec2 instance with full configured lamp 
...
---
 - name: "Deploying ec2 instance with LAMP Stack"
   ...
   vars:
     ...
     security_group: ansible-lamp
     image: ami-08f63db601b82ff5f
     region: ap-south-1
     keypair: ansible-syam
     exact_count: 1
     subnet: subnet-e3d796af
     hostkey: /home/ec2-user/key.pem
   ...
   tasks:
     ...
     - name: "Apache - Creating index.html"
       ...
       become: yes
       copy:
         content: " <h1><center> This linux server running on {{ ec2_status.instances.0.public_ip }} </center></h1>"
